...
render() {
    return (
      <SafeAreaView style={{flex:1}}>
        <Image source={require('./Images/graphics.jpg')} style={styles.backgriundImage}>
        </Image>
